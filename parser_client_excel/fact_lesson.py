...
class Selenium_test():
    ...
    def parser_clients_base(self):
        with open(fr'parser_klient_excel/json/klient_{date.today()}.json', encoding='utf-8') as f:
        ...
        with open(f'parser_klient_excel\json\klient_fact{date.today()}.json', 'w', encoding='utf-8') as f:
